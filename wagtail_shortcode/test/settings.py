...
ROOT_URLCONF = "wagtail_shortcode.test.urls"
...
DATABASES = {
    "default": dj_database_url.config(default="sqlite:///test_wagtail_shortcode.db"),
}
...
WAGTAIL_SITE_NAME = "Wagtail shortcode test site"
